# Generated by Django 4.0.4 on 2022-07-09 07:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=45, verbose_name='Актёр или режисёр')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=45, verbose_name='Фильм')),
                ('description', models.TextField(verbose_name='Описание')),
                ...
                ('premiere', models.DateField(default=datetime.date.today, verbose_name='Премьера')),
                ('budget', models.PositiveIntegerField(default=0, help_text='Сумма в доларах', verbose_name='Бюджет')),
                ('fees', models.PositiveIntegerField(default=0, help_text='Сумма в доларах', verbose_name='Сборы')),
                ('url', models.SlugField(max_length=70, unique=True)),
                ('draft', models.BooleanField(default=False, verbose_name='Черновик')),
                ('actors', models.ManyToManyField(related_name='film_actor', to='movies.actor', verbose_name='Режисёры')),
                ...
                ('director', models.ManyToManyField(related_name='film_director', to='movies.actor', verbose_name='Актёры')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(max_length=550, verbose_name='Сообщение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=45, verbose_name='Заголовок')),
                ('description', models.TextField(verbose_name='Описание')),
